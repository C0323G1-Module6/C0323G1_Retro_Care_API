...
import com.example.retro_care.supplier.service.impl.SupplierServiceImpl;
...
public class SupplierController_getListSupplier {
    ...
    public void getListStudent_5() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/0"))
    ...
    public void getListStudent_6() throws Exception {
        this.mockMvc.perform(
                ...
                .andExpect(jsonPath("content[0].debt").value("-2790000.0"))
                ...
                .andExpect(jsonPath("content[4].note").value("Đã thanh toán"))
