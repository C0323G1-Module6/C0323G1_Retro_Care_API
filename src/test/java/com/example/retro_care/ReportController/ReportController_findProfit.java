...
public class ReportController_findProfit {
    @Autowired
     ...
     */
    @Test
    public void findProfit_validateDto_startDate_1() throws Exception {
        ValidateDto validateDto = new ValidateDto();
        validateDto.setStartDate(null);
        validateDto.setEndDate("2023-03-13");
        this.mockMvc.perform(MockMvcRequestBuilders
                        .get("/api/report/chart/profit")
     ...
     */
    @Test
    public void findProfit_validateDto_startDate_2() throws Exception {
        ValidateDto validateDto = new ValidateDto();
     ...
     */
    @Test
    public void findProfit_validateDto_startDate_3() throws Exception {
        ValidateDto validateDto = new ValidateDto();
     ...
     */
    @Test
    public void findProfit_validateDto_startDate_4() throws Exception {
        ValidateDto validateDto = new ValidateDto();
     ...
     */
    @Test
    public void findProfit_validateDto_startDate_99() throws Exception {
        ValidateDto validateDto = new ValidateDto();
     ...
     */
    @Test
    public void findProfit_validateDto_endDate_1() throws Exception {
        ValidateDto validateDto = new ValidateDto();
        validateDto.setStartDate("2023-03-10");
     ...
     */
    @Test
    public void findProfit_validateDto_endDate_2() throws Exception {
        ValidateDto validateDto = new ValidateDto();
        validateDto.setStartDate("2023-03-10");
     ...
     */
    @Test
    public void findProfit_validateDto_endDate_3() throws Exception {
        ValidateDto validateDto = new ValidateDto();
        validateDto.setStartDate("2023-03-10");
     ...
     */
    @Test
    public void findProfit_validateDto_endDate_4() throws Exception {
        ValidateDto validateDto = new ValidateDto();
        validateDto.setStartDate("2023-03-10");
        validateDto.setEndDate("2023-03-13");
        this.mockMvc.perform(MockMvcRequestBuilders
     ...
     */
    @Test
    public void findProfit_validateDto_endDate_99() throws Exception {
        ValidateDto validateDto = new ValidateDto();
        validateDto.setStartDate("2023-03-10");
     ...
     */
    @Test
    public void findProfit_validateDto_endDate_98() throws Exception {
        ValidateDto validateDto = new ValidateDto();
